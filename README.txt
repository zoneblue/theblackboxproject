...
3. make sure that the /modules/midnite_classic/newmodus* files are executable
3a. edit /config/config-main.php (may need to rename from config-main-skel.php) to give database permissions (requires table create).
